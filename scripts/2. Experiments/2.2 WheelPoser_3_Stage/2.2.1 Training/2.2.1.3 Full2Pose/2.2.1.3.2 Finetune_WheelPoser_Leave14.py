...
model_names = ["Full2Pose_WheelPoser_AMASS"]
...
# %%
# load model
pretrained_config = Config(experiment=experiment_names, model="Full2Pose_WheelPoser_AMASS", project_root_dir=".", joints_set=joint_set.WheelPoser, pred_joints_set=joint_set.upper_body,
...
# %%
# setup Config
config = Config(experiment=experiment_names, model="Full2Pose_WheelPoser_WHEELPOSER", project_root_dir=".", joints_set=joint_set.WheelPoser, pred_joints_set=joint_set.upper_body,
                normalize=True, r6d=True, loss_type="mse", use_joint_loss=False, upper_body_only=False, exp_setup='leave_14_out', upsample_copies=7)
