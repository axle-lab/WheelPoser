...
config = Config(experiment=experiment_names, model="Full2Pose_WheelPoser_AMASS", project_root_dir=".", joints_set=joint_set.WheelPoser, pred_joints_set=joint_set.upper_body,
