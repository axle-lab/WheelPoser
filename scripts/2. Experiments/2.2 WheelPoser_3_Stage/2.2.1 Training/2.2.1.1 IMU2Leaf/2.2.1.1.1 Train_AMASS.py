r"""
3-stage biRNN Style WheelPoser model with AMASS Dataset
"""
...
config = Config(experiment=experiment_names, model="IMU2Leaf_WheelPoser_AMASS", project_root_dir=".", joints_set=joint_set.WheelPoser, pred_joints_set=joint_set.upper_body,
