...
model_names = ["IMU2Leaf_WheelPoser_AMASS"]
...
# %%
# load model
pretrained_config = Config(experiment=experiment_names, model="IMU2Leaf_WheelPoser_AMASS", project_root_dir=".", joints_set=joint_set.WheelPoser, pred_joints_set=joint_set.upper_body,
...
# %%
# setup Config
config = Config(experiment=experiment_names, model="IMU2Leaf_WheelPoser_WHEELPOSER", project_root_dir=".", joints_set=joint_set.WheelPoser, pred_joints_set=joint_set.upper_body,
